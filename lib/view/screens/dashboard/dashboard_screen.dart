...
import 'package:flutter_restaurant/view/screens/home/home_page.dart';
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar:  Provider.of<SplashProvider>(context, listen: false).isRestaurantClosed() && !ResponsiveHelper.isDesktop(context) ? PreferredSize(
