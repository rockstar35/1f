  ...
  void initState() {
    ...
    if (widget.productType == ProductType.POPULAR_PRODUCT) {
      Provider.of<ProductProvider>(context, listen: false).getPopularProductList(
        context, true, '1', Provider.of<LocalizationProvider>(context, listen: false).locale.languageCode,
      );
    }
      ...
      widget.scrollController?.addListener(() {
        ...
        if (widget.scrollController.position.pixels == widget.scrollController.position.maxScrollExtent
          ...
          if (Provider.of<ProductProvider>(context, listen: false).offset < pageSize) {
            ...
            Provider.of<ProductProvider>(context, listen: false).getPopularProductList(
              context, false, Provider.of<ProductProvider>(context, listen: false).offset.toString(), Provider.of<LocalizationProvider>(context, listen: false).locale.languageCode,
            );
          }
        }
      });
      ...
      builder: (context, prodProvider, child) {
        ...
        return Column(children: [
          productList != null ? productList.length > 0 ? GridView.builder(
            ...
            SliverGridDelegateWithFixedCrossAxisCount(crossAxisSpacing: 5, mainAxisSpacing: 5, childAspectRatio: 3.5,crossAxisCount: ResponsiveHelper.isTab(context) ? 2 : 1),
          ...
          productList != null ? Padding(
            ...
            Center(child: Padding(
              ...
              child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Theme.of(context).primaryColor)),
                ...
                :(_productProvider.offset == (Provider.of<ProductProvider>(context, listen: false).popularPageSize / 10).ceil())
                ? SizedBox()
                : SizedBox(width: 500,
