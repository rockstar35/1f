              ...
              child: SizedBox( width: 1170,
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Provider.of<SplashProvider>(context, listen: false).isRestaurantClosed() ? Text(
                            ...
                            child: CustomTextField(
                              ...
                              onSubmit: (text) {
                                  if (search.searchController.text.length > 0) {
                                    Provider.of<SearchProvider>(context,listen: false).saveSearchAddress(search.searchController.text);
                                    Provider.of<SearchProvider>(context,listen: false).searchProduct(search.searchController.text, context);
                                    Navigator.pushNamed(context, Routes.getSearchResultRoute(search.searchController.text), arguments: SearchResultScreen(searchString: search.searchController.text));
