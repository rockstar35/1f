...
import 'package:flutter_restaurant/view/screens/checkout/check_out_new.dart';
...
import 'package:flutter_restaurant/view/screens/basket/basket_screen.dart';
...
//*******Handlers*********
  ...
  /////////////////////////////////////////////
  static Handler _checkouttestHandler = Handler(handlerFunc: (context, Map<String, dynamic> params) => CheckOutNew());
  static Handler _basketHandler = Handler(handlerFunc: (context, Map<String, dynamic> params) => BasketScreen());
...
//*******Route Define*********
  static void setupRouter() {
    ...
    /////////////////////////////
    router.define(Routes.CHECKOUT_SCREEN_TEST, handler: _checkouttestHandler, transitionType: TransitionType.fadeIn);
    router.define(Routes.BASKET_SCREEN, handler: _basketHandler, transitionType: TransitionType.fadeIn);
